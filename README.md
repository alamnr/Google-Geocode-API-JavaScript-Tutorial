...
This repo's code is written by following the "Google Geocode API & JavaScript Tutorial" youtube video tutorials which are created by Sir Brad Traversy (Youtube Channel:Traversy Media). 
